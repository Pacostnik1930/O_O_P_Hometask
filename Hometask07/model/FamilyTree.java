...
public class FamilyTree<T extends Animale> implements Iterable<T>, Serializable 
{
    ...
    {
        String res = "В семье " + familyTree.size() + " человек(а):\n";
