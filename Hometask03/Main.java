...
import Hometask03.Comporator.HumanComporatorByAge; // компаратор лежит в отдельной папке !
public class Main
{
    public static void main(String[] args)
    {
        ...
        FamilyTree familyFree = new FamilyTree();
     ...
     /* System.out.println(mary);
        ...
        System.out.println("\nСортировка по имени=>");
        FamilyTree.getFamilyFree().sort(null);
        //сортировка использует метод compareTo в классе Human!
        //моя сортировка по умолчанию (по имени)
        for (Human human : FamilyTree.getFamilyFree())
        {
             System.out.println(human); // вывод через цикл foreach
        }

        System.out.println("\nСортировка по возрасту=>");
        FamilyTree.getFamilyFree().sort(new Hometask03.Comporator.HumanComporatorByAge());
        ...
        FamilyTree.addFamilyFree(new Human("Майк", "муж.", 3, anne, familyFree.getByName("виктор")));
